...
* Функции компелируемы и хранятся на стороне БД, поэтому их вызов стоит дешево.
* Разграничение работы разработчиков, занимающихся БД и разработчиков, занимающихся клиентскими приложениями (например, на Python).
* Хранить код, который работает с кортежами данных логичнее билиже к данным (SRP - Single Responsibility Principle)
* переиспользование функций различными клиентскими приложениями
* уравление безопасностью через регулирование доступа к функциям. Функции - это объекты в БД и как и к любым другим объектам, к ним можно прописывать права доступа.
